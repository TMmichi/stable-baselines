...
class CQLPolicy(BasePolicy):
    """
    Policy object that implements a CQL-like actor critic
    ...
    def __init__(self, sess, ob_space, ac_space, n_env=1, n_steps=1, n_batch=None, reuse=False, scale=False):
        super(CQLPolicy, self).__init__(sess, ob_space, ac_space, n_env, n_steps, n_batch, reuse=reuse, scale=scale)
...
class FeedForwardPolicy(CQLPolicy):
    """
